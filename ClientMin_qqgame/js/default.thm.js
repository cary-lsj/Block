var egret = window.egret;window.gameSkin=window.gameSkin||{};
	...
	var HumorSkin$Skin2 = 	(function (_super) {
		__extends(HumorSkin$Skin2, _super);
		function HumorSkin$Skin2() {
			_super.call(this);
		...
		var _proto = HumorSkin$Skin2.prototype;
	...
	function HumorSkin() {
		_super.call(this);
		this.skinParts = ["btn_close","btn_save","edit_text"];
		
		this.height = 1136;
		this.width = 640;
		this.elementsContent = [this._ScaleButton1_i(),this._Image1_i(),this._Image2_i(),this._Image3_i(),this.btn_close_i(),this.btn_save_i(),this.edit_text_i()];
	}
	...
	var MainSkin$Skin6 = 	(function (_super) {
		__extends(MainSkin$Skin6, _super);
		function MainSkin$Skin6() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = MainSkin$Skin6.prototype;
		...
		return MainSkin$Skin6;
	})(eui.Skin);

	var MainSkin$Skin7 = 	(function (_super) {
		__extends(MainSkin$Skin7, _super);
		function MainSkin$Skin7() {
			_super.call(this);
			this.skinParts = ["group"];
		...
		var _proto = MainSkin$Skin7.prototype;
		...
		return MainSkin$Skin7;
	})(eui.Skin);

	var MainSkin$Skin8 = 	(function (_super) {
		__extends(MainSkin$Skin8, _super);
		function MainSkin$Skin8() {
			_super.call(this);
			this.skinParts = ["group"];
		...
		var _proto = MainSkin$Skin8.prototype;
		...
		return MainSkin$Skin8;
	})(eui.Skin);

	function MainSkin() {
		_super.call(this);
		this.skinParts = ["map","grp_mood","btn_menu","img_starbg","starnum","map_rect","btn_key","btn_refresh","btn_setup","keynum"];
		
		this.height = 1136;
		this.width = 640;
		this.elementsContent = [this._Image1_i(),this._Image2_i(),this.map_i(),this.grp_mood_i(),this.btn_menu_i(),this.img_starbg_i(),this.starnum_i(),this.map_rect_i(),this.btn_key_i(),this.btn_refresh_i(),this.btn_setup_i(),this.keynum_i()];
	}
	...
	var MenuSkin$Skin12 = 	(function (_super) {
		__extends(MenuSkin$Skin12, _super);
		function MenuSkin$Skin12() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = MenuSkin$Skin12.prototype;
		...
		return MenuSkin$Skin12;
	})(eui.Skin);

	var MenuSkin$Skin13 = 	(function (_super) {
		__extends(MenuSkin$Skin13, _super);
		function MenuSkin$Skin13() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = MenuSkin$Skin13.prototype;
		...
		return MenuSkin$Skin13;
	})(eui.Skin);

	var MenuSkin$Skin14 = 	(function (_super) {
		__extends(MenuSkin$Skin14, _super);
		function MenuSkin$Skin14() {
			_super.call(this);
			this.skinParts = [];
		...
		var _proto = MenuSkin$Skin14.prototype;
		...
		return MenuSkin$Skin14;
	})(eui.Skin);

	function MenuSkin() {
		_super.call(this);
		this.skinParts = ["btn_rank","btn_start","btn_continue","btn_fight","grp_dw","btn_shop","btn_share","DiamondText","GoldText"];
		
		this.height = 1136;
		this.width = 640;
		this.elementsContent = [this.btn_rank_i(),this._SetView1_i(),this.grp_dw_i(),this.btn_shop_i(),this.btn_share_i(),this._Image2_i(),this._Image3_i(),this.DiamondText_i(),this.GoldText_i(),this._Image4_i(),this._Image5_i(),this._Image6_i()];
	}
	...
	var msgSkin$Skin15 = 	(function (_super) {
		__extends(msgSkin$Skin15, _super);
		function msgSkin$Skin15() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = msgSkin$Skin15.prototype;
	...
	function RankItemSkin() {
		_super.call(this);
		this.skinParts = ["txt_rank","txt_starNum","lab_name","img_head"];
		
		this.elementsContent = [this._Image1_i(),this._Image2_i(),this.txt_rank_i(),this.txt_starNum_i(),this.lab_name_i(),this.img_head_i()];
	}
	...
	_proto._Image1_i = function () {
		var t = new eui.Image();
		t.height = 100;
		t.scale9Grid = new egret.Rectangle(34,24,9,32);
		t.source = "common_json.por_num_bg";
		t.width = 480;
		return t;
	};
	...
	var RankSkin$Skin27 = 	(function (_super) {
		__extends(RankSkin$Skin27, _super);
		function RankSkin$Skin27() {
			_super.call(this);
			this.skinParts = [];
			
		}
		var _proto = RankSkin$Skin27.prototype;

		return RankSkin$Skin27;
	})(eui.Skin);
	...
	_proto.group_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this._Image1_i(),this._Image2_i(),this.btn_close_i(),this.sc_rank_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
	...
	_proto._ArrayCollection1_i = function () {
		...
		t.source = [this._Object5_i(),this._Object6_i(),this._Object7_i(),this._Object8_i(),this._Object9_i(),this._Object10_i(),this._Object11_i()];
		return t;
	};
	...
	var SetSkin$Skin37 = 	(function (_super) {
		__extends(SetSkin$Skin37, _super);
		function SetSkin$Skin37() {
			_super.call(this);
			this.skinParts = ["group"];
		...
		var _proto = SetSkin$Skin37.prototype;
	...
	var ShopSkin$Skin38 = 	(function (_super) {
		__extends(ShopSkin$Skin38, _super);
		function ShopSkin$Skin38() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = ShopSkin$Skin38.prototype;
	...
	var TestSkin$Skin43 = 	(function (_super) {
		__extends(TestSkin$Skin43, _super);
		function TestSkin$Skin43() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = TestSkin$Skin43.prototype;
	...
	__extends(TestSkin, _super);
	var TestSkin$Skin44 = 	(function (_super) {
		__extends(TestSkin$Skin44, _super);
		function TestSkin$Skin44() {
			_super.call(this);
			this.skinParts = [];
			
		}
		var _proto = TestSkin$Skin44.prototype;

		return TestSkin$Skin44;
	})(eui.Skin);
	...
	var ToolSkin$Skin46 = 	(function (_super) {
		__extends(ToolSkin$Skin46, _super);
		function ToolSkin$Skin46() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = ToolSkin$Skin46.prototype;
	...
	var WinSkin$Skin51 = 	(function (_super) {
		__extends(WinSkin$Skin51, _super);
		function WinSkin$Skin51() {
			_super.call(this);
			this.skinParts = ["group"];
		...
		var _proto = WinSkin$Skin51.prototype;
		...
		return WinSkin$Skin51;
	})(eui.Skin);

	var WinSkin$Skin52 = 	(function (_super) {
		__extends(WinSkin$Skin52, _super);
		function WinSkin$Skin52() {
			_super.call(this);
			this.skinParts = ["group"];
		...
		var _proto = WinSkin$Skin52.prototype;
		...
		return WinSkin$Skin52;
	})(eui.Skin);

	function WinSkin() {
		_super.call(this);
		this.skinParts = ["starThree","starTwo","starOne","comeOne","goOne","seeAd","btn_close","btn_next","btn_again","btn_rank","image","image0","image1","image2","btn_ad","btn_share","image3","group"];
	...
	_proto.group_i = function () {
		...
		t.height = 1136;
		t.width = 640;
		t.elementsContent = [this._Image1_i(),this._Image2_i(),this.btn_close_i(),this.btn_next_i(),this.btn_again_i(),this.btn_rank_i(),this.image_i(),this._Image3_i(),this._Image4_i(),this.image0_i(),this.image1_i(),this.image2_i(),this.btn_ad_i(),this.btn_share_i(),this.image3_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
