...
var game;
(function (game) {
    var GamerInfoCFG = (function () {
        function GamerInfoCFG() {
            this._GamerInfoMap = {
        ...
        GamerInfoCFG.prototype.getGamerInfo = function () {
            var id = this.RandomNumBoth(0, 47);
            return this._GamerInfoMap[id];
        };
        GamerInfoCFG.prototype.RandomNumBoth = function (Min, Max) {
            var Range = Max - Min;
    ...
    game.GamerInfoCFG = GamerInfoCFG;
    __reflect(GamerInfoCFG.prototype, "game.GamerInfoCFG");
})(game || (game = {}));
