...
(function (game) {
     ...
     * @author wizardc
     */
    var ParticleRes = (function (_super) {
        __extends(ParticleRes, _super);
        function ParticleRes() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this._status = 0 /* noload */;
            _this._usingCount = 0;
            return _this;
        }
        Object.defineProperty(ParticleRes.prototype, "url", {
            get: function () {
        ...
        Object.defineProperty(ParticleRes.prototype, "status", {
            get: function () {
                return this._status;
            },
            enumerable: true,
        ...
        Object.defineProperty(ParticleRes.prototype, "usingCount", {
            get: function () {
        ...
        Object.defineProperty(ParticleRes.prototype, "lastUseTime", {
            get: function () {
        ...
        Object.defineProperty(ParticleRes.prototype, "liveTime", {
            get: function () {
        ...
        Object.defineProperty(ParticleRes.prototype, "data", {
            get: function () {
        ...
        ParticleRes.prototype.init = function (url, liveTime) {
        ...
        ParticleRes.prototype.addUsing = function () {
            ++this._usingCount;
        };
        ParticleRes.prototype.subtractUsing = function () {
            --this._usingCount;
        ...
        ParticleRes.prototype.load = function () {
        ...
        ParticleRes.prototype.loadData = function () {
        ...
        ParticleRes.prototype.destroy = function () {
            if (true) {
                if (this._usingCount > 0) {
        ...
        ParticleRes.prototype.dispose = function () {
            this._usingCount = 0;
        ...
        ParticleRes.prototype.onRecycle = function () {
            this.dispose();
        };
        return ParticleRes;
    }(egret.EventDispatcher));
    game.ParticleRes = ParticleRes;
    __reflect(ParticleRes.prototype, "game.ParticleRes", ["game.IRes", "game.IDestroy"]);
})(game || (game = {}));
